...
pv=proverif
# tmp_f="/tmp/tmp.pv"
title="provision-def1"
prov_f="./model/provision-def1.pv"
...
# Basic modules are implemented in "./model/provision-def1.pv".
# In this script, we model the first defense proposed in the paper for the provisioning protocol.
# In this defese, the provisioner checks whether the received random value from the device is the same as the one it send.
# If they are the same, aborts the connection.
...
echo "Verifying Mesh provisioning with defense 1 finished."